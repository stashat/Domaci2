while True:
    ...
    if n>=1 and n<=1000000:
        ...
        print("Otvorenih vrata od " + str(n) + " vrata i ucenika: " + str(sum(sva_vrata)))
        # print(list(enumerate(sva_vrata)))
        otvorena_vrata = []
        otvorena_vrata = [br_vrata+1 for br_vrata, status_vrata in enumerate(sva_vrata) if status_vrata]
        #for j in range(n):
        #    if sva_vrata[j]:
        #        otvorena_vrata.append(j+1)
